...
All commits must include a DCO sign-off and a cryptographic signature (`git commit -s -S`). Semantic-release on main generates tags and changelog from commit types.
