...
The `helm template` command requires a local clone of the [DSX Exchange repository](https://github.com/dsx-ai-factory/dsx-exchange). Render the release configuration locally, from the repository root:
