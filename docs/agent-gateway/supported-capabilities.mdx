...
The following table defines the supported Agent Gateway method profile. Methods outside this table are not part of the documented support profile.
...
| Stateful resource methods | Not included in the supported Agent Gateway profile. | Not supported. |
